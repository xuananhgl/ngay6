...
<div id="lider" style="background-color:<?= $header['background'] ?>">
                     ...
                     <div class="header_container" >
                            ...
                            <?= $this->Html->image($header->img) ?>
                                ...
                                <div class="container_item">
                                    <button class="js-open-video"><i class="fa-solid fa-circle-play"></i><div class="item_vd">
                                            <p style="color: <?= $header['color'] ?>;"><?= __('voir la vidéo') ?></p>
                                    </button>
                                </div>
                                </div>
                            </div>
                        ...
                        <div class="video js-video">
                                    <div class="set_video">
                                    <i class="fa-solid fa-xmark js-close-video" style="cursor: pointer;"></i>
                                    </div>
                        </div>
...
<?php foreach ($pours as $pour): ?>
        ...
        <div class="model js-model">
            <div class="set_changer">
                ...
                <div class="langue">
                                        ...
                                        echo $this->Form->create(NULL,array('url'=>'/headers'));
        ...
        <!-- <script>
                ...
                openMdal.addEventListener('click', showVideo)
                closeMdal.addEventListener('click', hideVideo)
